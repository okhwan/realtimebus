...
public class RealTimeBusInfoService {
    ...
    public List<RealTimeBusInfoDto> realTimeService(String startStationNumber) {
        //크롬 드라이버 사용하기 위해 로딩
...
//        버스 id 로 검색할 거라 버스 정류장 명 에서 id로 클릭해서 바꿈
        ...
        realTimeBusList(driver, realTimeBus);
    ...
    private static void realTimeBusList(WebDriver driver, List<RealTimeBusInfoDto> realTimeBus) {
